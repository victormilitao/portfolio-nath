      ...
      <div className='flex justify-center mt-10'>
        <div className='flex flex-col max-w-[650px] text-lg'>
          ...
          <div className='mt-3'>
            <Title
              type='2'
              text='Aplicação das métricas piratas ao nosso cenário'
            />
          </div>
          <p className='mt-2'>
          ...
          <div className='mt-12'>
            <Title type='2' text='Métrica 2: Retenção' />
          </div>
          <p className='mt-3'>
            <Title
              type='6'
              text='O cliente está utilizando a Gestão Completa de Férias?'
            />
          ...
          <p className='mt-3'>
            <Title
              type='6'
              text='O cliente está satisfeito com a Gestão Completa de Férias?'
            />
          ...
          <p className='mt-3'>
            <Title
              type='6'
              text='O cliente está precisando acionar o suporte para utilizar a Gestão
              Completa de Férias?'
            />
          ...
          <div className='mt-10'>
            <Title type='2' text='Minha atuação no projeto' />
          </div>
          <p className='mt-3'>
